...
def prout2anto(chaineA,chaineB,nomfichier):
    ...
    pourcentbastete = []
    toutemoyennetete = []
    chemin_fichier = f"/home/mat/Bureau/avoir la suite/{nomfichier}.txt"
...
prout2anto(1,5000,'1')
#prout2anto(5000, 10000,'2')
#prout2anto(10000, 15000,'3')
#prout2anto(15000, 18000,'4')
